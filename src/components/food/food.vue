...
import ratingMixin from '@/common/mixins/rating.ts'
import popupMixin from '@/common/mixins/popup.ts'
...
export default class Food extends Mixins(popupMixin, ratingMixin) {
  // props start -----------
  @Prop({ type: Object }) private food!: object
  // props end ------------
  ...
  private addFirst(event: any) {
    this.$set(this.food, 'count', 1)
    this.$emit(EVENT_ADD, event.target)
  }
  private addFood(target: any) {
    this.$emit(EVENT_ADD, target)
  }
  private format(time: any) {

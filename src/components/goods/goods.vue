...
export default class Goods extends Vue {
  // props start --------
  @Prop({ default: [], type: Object }) private data!: any
  // props end ------------
  ...
  private selectFood(food: Element) {
    this.selectedFood = food
    this._showFood()
    this._showShopCartSticky()
  }
  private onAdd(target: Element) {
    const shopCart: any = this.$refs.shopCart
